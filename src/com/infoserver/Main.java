 ...
 * <li>Utilizar somente as
 * funcionalidades do JDBC e do JSE(Java Standard Edition); 
 * <li>Este sistema roda em
 * JSE, ou seja, não roda em servidores de aplicações (Jboss, Tomcat, WebSphere,
 * etc); 
 * <li>Utilize conceitos de Orientação a Objetos (Beans) e a API do Java para
 * realizar as operações necessárias; 
 * <li>As tabelas estão preenchidas e não há
 * necessidade de desenvolver funcionalidades para carga dos dados; 
 * <li>O Cálculo do
 * valor líquido não poderá ser resolvido pela query do banco de dados;
...
public class Main {
    ...
    public static void main(String[] args) {
        new CalculadoraSalarioLiquido().executa();
    }
